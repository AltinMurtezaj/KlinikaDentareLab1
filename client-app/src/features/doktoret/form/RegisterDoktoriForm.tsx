...
export default observer(function RegisterDoktoriForm(){
    ...
    return(
        <Formik
            initialValues={{
                ...
                password: '',
                 error: null}}
            onSubmit={(values, {setErrors}) => userStore.registerDoktori(values).then(()=>navigate('/doktoret')).catch(error =>
            ...
            validationSchema={Yup.object({
                ...
                specializimi: Yup.string().required(),
                kualifikimi: Yup.string().required(),
            })}
        >
            {({handleSubmit, isSubmitting, errors, isValid, dirty}) => (
                <Form className="ui form error" onSubmit={handleSubmit} autoComplete='off'>
                    ...
                    <MyTextInput name='specializimi' placeholder="Specializimi"/>
